...
public class RobotContainer {
    ...
    private final DriveSubsystem    driveSubsystem    = new DriveSubsystem(lightsSubsystem, visionSubsystem);
    ...
    public RobotContainer() {
        ...
        elevatorSubsystem.setDefaultCommand(
            new DefaultElevatorCommand(elevatorSubsystem, operatorInput, lightsSubsystem));
